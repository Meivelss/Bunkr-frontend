...
<template>
  <TooltipPortal>
    ...
    >
      ...
      <TooltipArrow
        class="z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] bg-white fill-white"
      />
    </TooltipContent>
  </TooltipPortal>
</template>
