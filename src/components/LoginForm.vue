...
<template>
  <div class="flex w-full flex-col space-y-4 select-none">
    <div class="flex w-full">
      <h1 v-if="!awaiting2FA" class="text-4xl font-bold text-white font-header">
        Zaloguj się
      </h1>
    ...
    >
      ...
      >
        <div class="flex items-center gap-x-2">
          ...
          />
          <label for="remember" class="font-text">Zapamiętaj mnie</label>
        </div>
        <a
          href="/forgot-password"
          class="decoration-red-800/50 decoration-3 hover:underline font-text"
          >Zapomniałeś hasło?</a
        >
      </div>
      <Button
